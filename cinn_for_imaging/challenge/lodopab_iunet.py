"""
Evaluate IUnetReconstructor on the 'lodopab' challenge set.
"""
...
path_parts = path_parts = ['..', 'experiments', 'lodopab', 'iunet', 'default',
...
output_name = model_version + '_' + chkp_name + '_seed=' + str(eval_seed) + \
                    '_images='  + str(NUM_IMAGES) + \
                    '_samples=' + str(reconstructor.samples_per_reco)
